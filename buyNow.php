...
<div class="addressBox">
    <form method="POST">
        <fieldset>
            ...
            <input type="radio" name="pay" value="COD" class="pay"><span>COD</span>
            <input type="radio" name="pay" value="UPI"><span>UPI</span>
            <input type="radio" name="pay" value="CARD"><span>Credit/Debit</span>
            <br>
